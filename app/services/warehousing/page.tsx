  ...
  return (
    <main className="bg-white text-[#0a1628]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden bg-[#0a1628]">
        ...
        />
        <div className="absolute bottom-0 left-0 w-64 h-64 border border-[#2e6be6]/20 rounded-full translate-y-1/2 -translate-x-1/2" />
        <div className="absolute top-10 right-10 w-32 h-32 border border-[#c9a84c]/20 rounded-full" />
